...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark px-4">
    <a class="navbar-brand fw-bold">
      <img src="<?php echo e(asset('assets/logo.png')); ?>" alt="Dental Logo" width="40" height="40" class="me-2">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        <li class="nav-item"><a class="nav-link mx-3" href="<?php echo e(url("/home")); ?>">Home</a></li>
        <li class="nav-item"><a class="nav-link mx-3" href="<?php echo e(url("/register")); ?>">Register</a></li>
        <li class="nav-item"><a class="nav-link mx-3" href="<?php echo e(url("/login")); ?>">Login</a></li>
      </ul>
    </div>
  </nav>
    ...
    <div class="container-fluid px-5">
      <div class="row align-items-center">
        <div class="col-md-6 hero-left">
          ...
          <a href="<?php echo e(url("/login")); ?>" class="btn btn-primary">Get Started <i class="bi bi-arrow-right"></i></a>
        </div>
...
<?php /**PATH C:\Users\adaaz\SmileSyncV2\resources\views/landingpage.blade.php ENDPATH**/ ?>