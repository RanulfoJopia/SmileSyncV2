...
<head>
    ...
    <style>
        /* Ensures the whole viewport height is used */
        ...
        .sidebar {
            /* Using a fixed width for the sidebar for consistent look */
            background: white;
            min-height: 100vh;
            padding: 20px;
            box-shadow: 2px 0 10px rgba(0,0,0,0.05);
            /* Important for full height sidebar and sticky navigation */
            position: sticky;
            top: 0;
        }
        /* Corrected active link styling for better contrast */
        .sidebar .nav-link {
            color: #333;
            font-weight: 500;
            border-radius: 5px;
        ...
        <div class="col-md-10 p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h3 class="fw-bold text-primary">
                    <i class="bi bi-folder-plus me-2"></i>Medical Records
                </h3>
